...
[num1,txt1,raw1]=xlsread('my_summary_mean_freq_all_conds.xls');

[num2,txt2,raw2]=xlsread('induced_genes_outliers_removed_all_genes_all_conditions.xls');

genelist=txt1(2:281,1);
...
for i=1:100
   ...
   h=find(strcmp(genelist(i+100),singlenames)>0);
   x=num2(h,9);
   y=num2(h,6);
